- [基础绘制](#基础绘制)
  - [1. <a name='图形学'></a>图形学](#1-图形学)
  - [2. <a name='webgl'></a>WebGL 基础概念](#2-webgl-基础概念)
  - [3. <a name='GSGL'></a>GSGL基础](#3-gsgl基础)
    - [GLSL语言及编译：](#glsl语言及编译)
  - [4. <a name='webgl-1'></a>webgl绘制点线面](#4-webgl绘制点线面)
    - [4.1. <a name='const'></a>绘制没有变量的固定点（const）](#41-绘制没有变量的固定点const)
    - [4.2. <a name='attributevec4:'></a>绘制添加变量的多个点（attribute变量vec4类型）外联着色器](#42-绘制添加变量的多个点attribute变量vec4类型外联着色器)
    - [4.3. <a name='webgl:'></a>webgl简单封装](#43-webgl简单封装)
    - [最简三角面](#最简三角面)
    - [彩色三角 varying顶点](#彩色三角-varying顶点)
    - [全局变量uniform位移](#全局变量uniform位移)
...
研究内容非常广泛，如图形硬件、图形标准、图形交互技术、光栅图形生成算法、曲线曲面造型、实体造型、真实感图形计算与显示算法，以及科学计算可视化、计算机动画、自然景物仿真、虚拟现实等。
...
<iframe height="300" style="width: 100%;" scrolling="no" title="WebGL教程-WebGL基础-0.1.基础绘制——webgl绘制点线面————2绘制添加变量的多个点（attribute变量vec4类型）_外联_封装" src="https://codepen.io/itild/embed/VwyPbRY?default-tab=html%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
...
<iframe height="300" style="width: 100%;" scrolling="no" title="WebGL教程-WebGL基础-0.1.基础绘制——webgl绘制点线面————2绘制三角_外联_封装" src="https://codepen.io/itild/embed/JjMEJaX?default-tab=html%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
...
<iframe height="300" style="width: 100%;" scrolling="no" title="WebGL教程-WebGL基础-0.1.基础绘制——webgl绘制点线面————2绘制彩色三角varying传值" src="https://codepen.io/itild/embed/VwyPMOY?default-tab=html%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
...
<iframe height="300" style="width: 100%;" scrolling="no" title="WebGL教程-WebGL基础-0.1.基础绘制——webgl绘制点线面————2绘制彩色三角uniform偏移" src="https://codepen.io/itild/embed/mdpRqQB?default-tab=html%2Cresult" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
